...
export class ProductResolverBase {
  ...
  @graphql.Mutation(() => ProductResponseDto)
  async AddNewProduct(
    @graphql.Args()
    args: ProductResponseDto
  ): Promise<ProductResponseDto> {
    return this.service.AddNewProduct(args);
  }
  ...
  @graphql.Query(() => ProductResponseDto)
  async GetProductByName(
    @graphql.Args("args")
    args: string
  ): Promise<ProductResponseDto> {
    return this.service.GetProductByName(args);
  }
  ...
  async RemoveProduct(
    ...
    return this.service.RemoveProduct(args);
  }
}

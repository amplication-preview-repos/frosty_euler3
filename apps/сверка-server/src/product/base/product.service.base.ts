...
export class ProductServiceBase {
  ...
  async AddNewProduct(args: ProductResponseDto): Promise<ProductResponseDto> {
    throw new Error("Not implemented");
  }
  async EditProduct(args: ProductResponseDto): Promise<ProductResponseDto> {
    throw new Error("Not implemented");
  }
  async GetProductByName(args: string): Promise<ProductResponseDto> {
    throw new Error("Not implemented");
  }
  async RemoveProduct(args: string): Promise<boolean> {
    throw new Error("Not implemented");
  }
}
